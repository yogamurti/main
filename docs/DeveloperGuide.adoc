...
[NOTE]
Note how the `Model` simply raises a `TaskBookChangedEvent` when the Address Book data are changed, instead of asking the `Storage` to save the updates to the hard disk.
...
|`* * *` |user |find tasks by keywords |find tasks using certains keywords i remember
...
[[start]]
Start date and time of event/task

____
date and time follows their respective formats
____

[[end]]
End date and time of event/task

____
date and tiem follows their respective formats
____
...
>>>>>>> c26faf683b96c922ebcb3c9cfec0a054d5bfd3c1
