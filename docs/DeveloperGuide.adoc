...
2. System deletes the task and shows a success message
...
4. System updates its general options for the session and shows a success message
...
2. System saves the current to-do list and exports it as an _xml_ file in the directory specified
