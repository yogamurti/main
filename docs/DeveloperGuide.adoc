...
* Model: The `UI` component's `ResultDisplay`, `CategoryListPanel` and `TaskListPanel` binds themselves to some data in the link:#model[`Model`] component, which stores and maintains data in _2Do_.
