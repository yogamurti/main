...
* Model: The `UI` component's `ResultDisplay` and `TaskListPanel` binds themselves to some data in the link:#model[`Model`] component, which stores and maintains data in _2Do_.
