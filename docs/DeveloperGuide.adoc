...
1a. Multiple tasks with same name has been detected

____
1b1. 2Do displays all the relevant tasks, and their indices, and prompts the user to choose the intended task to delete
1b2. User chooses the task index
