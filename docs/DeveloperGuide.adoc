...
.  Should not require more than 2 seconds to startup.
.  Should not require more than 2 seconds to respond to a user request.
.  Should not require internet connection.
.  Should not take up significant system resources to run.
.  Should store the to-do list details in a permanent location in the OS.
