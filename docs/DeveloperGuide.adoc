...
** View: The `UI` component is responsible for displaying data, interacting with the user, and getting automatic data updates from the link:#model[`Model`] component.
