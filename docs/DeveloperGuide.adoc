...
|`* * *` |user |save my to-do list as a text file |have a back-up copy of my to-do list

|`* * *` |user |load a to-do list from a storage location |access my to-do list from different devices and be able to manage multiple to-do lists

|`* *` |user |mark tasks as cannot do |properly take tasks I am unable to complete out of my to-do list
