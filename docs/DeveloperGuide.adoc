...
|`* * *` |user |add tasks without specifying a date |add floating tasks
...
|`* * *` |user |add deadlines to my floating tasks |update floating tasks if they then require a deadline
...
____
Number assigned to a task to ease the operation of commands (e.g. add, delete, edit,view, mark as compllte)-
____
