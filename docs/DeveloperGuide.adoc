...
2. System adds the task and shows a success message
...
____
1b1. System automatically adjusts the end time to the following day
...
____
2a1. System displays a â€œNo task to displayâ€� message
...
____
2b1. System displays a â€œNo task to displayâ€� message
