...
image::images/MainScreen.png[width="600"]
...
****
* Floating tasks can be added with _start_, _end_ and _recurrence_ fields empty
...
****
* Tasks with deadlines can be added with the _start_ field empty and the _end_ field filled
****
