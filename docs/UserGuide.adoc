...
=== Redoing the last action : `redo / -r`

Format: `redo` +
Example: `redo`
****
* Redos the last successful undo action executed
****
...
* 2Do opens up with the to-do list in the last specified file path for every new session
****
...
****
* Loads the to-do list in the directory specified.
* To view the task in this to-do list, exit and reopen 2Do to refresh the page.
****
