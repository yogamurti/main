...
Format 1: `add [-h] n/{name} s/[start date] e/[end date] d/[description] t/[tag1, tag2,...] a/[early notification period] r/[recurrence] u/[urgent]` +
Example: `add n/CS2103 Project V0.1 s/Next Fri 2359hrs d/Special Term tag/NUS a/2 days r/yearly u/true`
****
...
Format: `edit [-h] {index} n/[new name] s/[new start date] e/[new end date] d/[new description] t/[new tags] a/[new notification period] r/[recurrence] u/[urgent]` +
Example: `edit 2 n/CS2103`
****
...
|add / -a /+|add [-h] n/{name} s/[start date] e/[end date] d/[description] t/[tag1, tag2,...] a/[notification period] r/[recurrence] u/[urgent]|add [-h] {title} on {date} at {time}
|delete / del / -d / -|delete [-h] {index}|delete[-h]  {title} on {date} at {time}
|list / -l|list [-h]|
|find / -f|find [-h] {keyword}|
|undo / -u|undo|
|edit / -e|edit [-h] {index} n/[new name] s/[new start date] e/[new end date] d/[new description] t/[new tags] a/[new notification period] r/[recurrence] u/[urgent]|
|view / -v|view [-h] {index}|
|mark / -m|mark {index}|
