...
<table>
	<tr>
		<th col span="2"> Arguments</th>
	</tr>
	<tr>
		<td> {} </td>
		<td> compulsory argument </td>
	<tr>
</table>
...
*A*: Install the app in the other computer and overwrite the empty data file it creates with the file that contains the data of your previous to-do list folder.
