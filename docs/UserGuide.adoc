...
Example: `add n/CS2103 Project s/03/05/17 2359 e/04/05/17 1159 d/Special Term t/NUS a/2 days r/yearly u/true`
****
...
Example: `edit 2 n/CS2103 s/19/06/17 1000 e/28/07/17 1430 d/Special Term t/NUS a/2 days u/true`
****
...
** This can be changed to automatically marking the activity as completed instead of prompting
****
