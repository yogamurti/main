...
public class EditCommandTest {
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() throws Exception {
        ...
        ReadOnlyTask editedPerson = model.getFilteredAndSortedTaskList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    public void execute_filteredList_success() throws Exception {
        ...
        ReadOnlyTask personInFilteredList = model.getFilteredAndSortedTaskList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    public void execute_duplicatePersonUnfilteredList_failure() throws Exception {
        Task firstPerson = new TaskWithDeadline(model
                .getFilteredAndSortedTaskList().get(INDEX_FIRST_PERSON.getZeroBased()));
